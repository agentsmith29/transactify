...
WSGI_APPLICATION = 'transactify.wsgi.application'
ASGI_APPLICATION = 'transactify.asgi.application'
...
DATABASE_ROUTERS = ['transactify.db_router.MultiDatabaseRouter']
