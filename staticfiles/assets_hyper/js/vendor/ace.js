(function () {
    ...
    define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/dom", "ace/lib/app_config", "ace/theme/textmate"], function (e, t, n) {
        ...
        var l = function () {
            !a.basePath &&
                ...
                (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"), (l = function () {}));
        };
        t.version = "1.11.2";
    }),
        ...
        (function () {
            (this.isBidiRow = function (e, t, n) {
                ...
                (this.getPosLeft = function (e) {
                    ...
                    return (
                        !this.session.getOverwrite() && e > t && s[i] % 2 === 0 && (o += this.charWidths[s[i]]), this.wrapIndent && (o += this.isRtlDir ? -1 * this.wrapOffset : this.wrapOffset), this.isRtlDir && (o += this.rtlLineOffset), o
                    );
                }),
    ...
    define("ace/mode/text", ["require", "exports", "module", "ace/config", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/behaviour/cstyle", "ace/unicode", "ace/lib/lang", "ace/token_iterator", "ace/range"], function (
        e,
        t,
        n
    ) {
            ...
            r.implement(this, u),
                ...
                (this.$setIndentGuideActive = function (e, t) {
                    ...
                    if (n !== "") {
                        ...
                        r && r[t - 1] && r[t - 1].classList && r[t - 1].classList.add("ace_indent-guide-active");
                    }
                }),
                ...
                (this.classSuffix = "-v"),
                    ...
                    (this.setInnerHeight = this.setScrollHeight = function (e, t) {
                        ...
                        (this.pageHeight = e),
                            ...
                            this.scrollTop > this.pageHeight - this.viewHeight && ((this.scrollTop = this.pageHeight - this.viewHeight), this.scrollTop < 0 && (this.scrollTop = 0), this._emit("scroll", { data: this.scrollTop }));
                    }),
                    (this.setScrollTop = function (e) {
                ...
                (this.classSuffix = "-h"),
                    ...
                    (this.setInnerWidth = this.setScrollWidth = function (e, t) {
                        ...
                        (this.pageWidth = e),
                            ...
                            this.scrollLeft > this.pageWidth - this.viewWidth && ((this.scrollLeft = this.pageWidth - this.viewWidth), this.scrollLeft < 0 && (this.scrollLeft = 0), this._emit("scroll", { data: this.scrollLeft }));
                    }),
                    (this.setScrollLeft = function (e) {
        ...
        (function () {
            (this.CHANGE_CURSOR = 1),
                ...
                (this.$renderChanges = function (e, t) {
                    ...
                    e & this.CHANGE_TEXT
                        ? ((this.$changedLines = null), this.$textLayer.update(n), this.$showGutter && this.$gutterLayer.update(n), this.$customScrollbar && this.$scrollDecorator.$updateDecorators(n))
                        : e & this.CHANGE_LINES
                        ? ((this.$updateLines() || (e & this.CHANGE_GUTTER && this.$showGutter)) && this.$gutterLayer.update(n), this.$customScrollbar && this.$scrollDecorator.$updateDecorators(n))
                        ...
                        : e & this.CHANGE_CURSOR && (this.$highlightGutterLine && this.$gutterLayer.updateLineHighlight(n), this.$customScrollbar && this.$scrollDecorator.$updateDecorators(n)),
