    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_fill_amount', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10)),
                ('nutri_score', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('resell_price', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='customer', to='store.customerconfig')),
            ],
        ),
        migrations.CreateModel(
