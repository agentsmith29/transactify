...
class OLEDPageUnknownProduct(OLEDPage):
    ...
    def view(self, ean, price, *args, **kwargs):
        ...
        draw.text((10, content_y_start + 14), f"interface under {ip_address}", font=self.font_small,fill=(255,255,255))
