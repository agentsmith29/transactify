"""
Django settings for cashlessui project.
...
SECRET_KEY = 'django-insecure-65f!o_#nl=6pseeo6ia_dz&3pppr49idmkch&^%gsccp$is&b^'
...
WSGI_APPLICATION = 'cashlessui.wsgi.application'
